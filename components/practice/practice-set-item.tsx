...
export const PracticeSetItem = ({ set }: PracticeSetItemProps) => {
  ...
  return (
    <Card isFooterBlurred radius="lg" className="border-none flex-none">
      ...
      <Link
        href={`/practice/sets/${id}`}
        className="justify-between before:bg-white/10 border-white/20 border-1 overflow-hidden absolute before:rounded-xl rounded-large bottom-1 w-[calc(100%_-_8px)] shadow-small ml-1 z-10"
      >
        <Button
